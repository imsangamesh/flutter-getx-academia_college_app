...
class SendAttendanceNotifications extends StatelessWidget {
  SendAttendanceNotifications({super.key});

  final msgCntr = TextEditingController(
      text:
          "Hello there! 7 sem student's attendance has been updated! Kindly view the same on our college application! Thank you!");
  final selectedSem = '7'.obs;

  void handleSemSelect(String? val) {
    selectedSem(val ?? '1');
    msgCntr.text =
        "Hello there! ${selectedSem()} sem student's attendance has been updated! Kindly view the same on our college application! Thank you!";
  }

  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: const Text('Send Attendance Notifications')),
      body: Padding(
            ...
            SizedBox(
              ...
              child: MyOutlinedBtn(
                ...
                () => Popup.confirm(
                  ...
                  yesFun: () => FCMApi.sendAttendanceUpdates(
                    selectedSem(),
                    msgCntr.text.trim(),
                  ),
                ),
